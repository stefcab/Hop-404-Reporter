...
$lang = array(
	...
	'set_email_address_sender_desc'		=> 'This email address will be used as the sender for each notification sent. If left empty, we will use the site setting email address',
